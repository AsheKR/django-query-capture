...
class BaseLinePrinter:
    @staticmethod
    def is_allow_print(query, **kwargs) -> bool:
        raise NotImplementedError
    ...
    @classmethod
    def print(cls, query: str, prefix: str = "", **kwargs):
...
class DuplicateMinCountPrinter(BaseLinePrinter):
    ...
    @classmethod
    def print(cls, query: str, prefix: str = "", count: int = 0):
